...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=keshavbhattad.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x6b, 0x65, 0x73, 0x68, 0x61, 0x76, 0x62,
	0x68, 0x61, 0x74, 0x74, 0x61, 0x64, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d,
	...
	0x24, 0x2e, 0x6b, 0x65, 0x73, 0x68, 0x61, 0x76, 0x62, 0x68, 0x61, 0x74, 0x74, 0x61, 0x64, 0x2e,
	...
	0x44, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x2c, 0x0a, 0x22,
	0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x6b, 0x65, 0x73, 0x68, 0x61,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: keshavbhattad.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: keshavbhattad.pcbook.Storage
	(*Memory)(nil),      // 2: keshavbhattad.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: keshavbhattad.pcbook.Storage.driver:type_name -> keshavbhattad.pcbook.Storage.Driver
	2, // 1: keshavbhattad.pcbook.Storage.memory:type_name -> keshavbhattad.pcbook.Memory
